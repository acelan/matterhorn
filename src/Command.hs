...
commandList =
  ...
  , Cmd "bye" ("對所有的人說：各位英雄後會有期")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對所有的人說：各位英雄後會有期")
  , Cmd "w" ("來，$1 喝杯高雄的自來水潤潤嗓子吧? 還有點甜呢.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("來，" <> msg <> " 喝杯高雄的自來水潤潤嗓子吧? 還有點甜呢.")
  , Cmd "ack" ("慘叫一聲, 滿臉「那也安捏?!?!?」的表情.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("慘叫一聲, 滿臉「那也安捏?!?!?」的表情.")
  , Cmd "addoil" ("對著 $1 高喊: 加油!!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對著 " <> msg <> " 高喊: 加油!!")
  , Cmd "agree" ("完全同意.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("完全同意.")
  , Cmd "ah" ("重重地拍了一下腦袋, 終於想到了!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("重重地拍了一下腦袋, 終於想到了!")
  , Cmd "angry" ("作出生氣的表情!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("作出生氣的表情!")
  , Cmd "applaud" ("鼓掌喝采!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("鼓掌喝采!")
  , Cmd "arc" ("挑起一邊的眉毛，古裡古怪地看著 $1。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("挑起一邊的眉毛，古裡古怪地看著 " <> msg <> "。")
  , Cmd "aluba" ("把 $1 抓去啊魯吧!魯～魯～")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("把 " <> msg <> " 抓去啊魯吧!魯～魯～")
  , Cmd "badboy" ("指著 $1 說 ：你是壞人!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("指著 " <> msg <> " 說 ：你是壞人!")
  , Cmd "bite" ("狠狠的咬了 $1 一口，把他咬的哇哇大叫...真爽 真爽")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("狠狠的咬了 " <> msg <> " 一口，把他咬的哇哇大叫...真爽 真爽")
  , Cmd "blink" ("眨眨眼睛，一臉無辜的樣子。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("眨眨眼睛，一臉無辜的樣子。")
  , Cmd "blush" ("的臉紅了起來!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("的臉紅了起來!")
  , Cmd "bow" ("對著 $1 躬身做揖。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對著 " <> msg <> " 躬身做揖。")
  , Cmd "bow1" ("對 $1 的景仰有如滔滔江水連綿不絕，又有如黃河氾濫一發不可收拾。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對 " <> msg <> " 的景仰有如滔滔江水連綿不絕，又有如黃河氾濫一發不可收拾。")
  , Cmd "buddha" ("在這一瞬間，覺得自己簡直跟神一樣。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("在這一瞬間，覺得自己簡直跟神一樣。")
  , Cmd "cat" ("叫了聲: 喵～")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("叫了聲: 喵～")
  , Cmd "coco" ("順手拿起一把木槌，把 $1 的大頭就當木魚一樣給他.. 扣扣扣 ) ) ) ) ) ) ) 哇>！還有回音！真不素普通的『空』")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("順手拿起一把木槌，把 " <> msg <> " 的大頭就當木魚一樣給他.. 扣扣扣 ) ) ) ) ) ) ) 哇>！還有回音！真不素普通的『空』")
  , Cmd "comfort" ("對著 $1 露出關愛的眼神! 說: 『 乖 $1, 惜惜! 』")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對著 " <> msg <> " 露出關愛的眼神! 說: 『 乖 " <> msg <> ", 惜惜! 』")
  , Cmd "cong" ("對著大家說道：恭喜恭喜！！")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對著大家說道：恭喜恭喜！！")
  , Cmd "cough" ("不停地咳嗽。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("不停地咳嗽。")
  , Cmd "cow" ("對著附近的人大喊：哇勒　靠....左邊站啦～")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對著附近的人大喊：哇勒　靠....左邊站啦～")
  , Cmd "cower" ("怕得一直發抖。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("怕得一直發抖。")
  , Cmd "cry" ("忍不住放聲大哭. 哇嗚...")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("忍不住放聲大哭. 哇嗚...")
  , Cmd "dance" ("快樂的手足蹈舞!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("快樂的手足蹈舞!")
  , Cmd "die" ("直挺挺的倒在地上 ... 死了。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("直挺挺的倒在地上 ... 死了。")
  , Cmd "dog" ("叫了聲: 汪～汪～")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("叫了聲: 汪～汪～")
  , Cmd "dunno" ("搖搖頭說道: 我不知道...")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("搖搖頭說道: 我不知道...")
  , Cmd "face" ("頑皮地做了個鬼臉:P")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("頑皮地做了個鬼臉:P")
  , Cmd "faint" ("昏倒了")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("昏倒了")
  , Cmd "fear" ("突然覺得莫名的恐懼!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("突然覺得莫名的恐懼!")
  , Cmd "flee" ("飛也似地逃了。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("飛也似地逃了。")
  , Cmd "flip" ("像瘋子一樣跳來跳去.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("像瘋子一樣跳來跳去.")
  , Cmd "flop" ("撲通地跌了一跤。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("撲通地跌了一跤。")
  , Cmd "fool" ("露出白癡般笑容對著大家笑...")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("露出白癡般笑容對著大家笑...")
  , Cmd "gg" ("為 $1 起立鼓掌!!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("為 " <> msg <> " 起立鼓掌!!")
  , Cmd "giggle" ("掩著嘴吃吃地笑著。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("掩著嘴吃吃地笑著。")
  , Cmd "gold" ("唱著：『金ㄍㄠˊ金ㄍㄠˊ 出國比賽! 得冠軍，拿金牌，光榮倒鄧來！』")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("唱著：『金ㄍㄠˊ金ㄍㄠˊ 出國比賽! 得冠軍，拿金牌，光榮倒鄧來！』")
  , Cmd "gozila" ("學起酷斯拉嗚啦鳴啦的怪叫..")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("學起酷斯拉嗚啦鳴啦的怪叫..")
  , Cmd "grin" ("臉上露出邪惡的笑容。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("臉上露出邪惡的笑容。")
  , Cmd "groan" ("痛苦地呻吟著。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("痛苦地呻吟著。")
  , Cmd "gun" ("被亂槍打死了.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("被亂槍打死了.")
  , Cmd "hammer" ("舉起好大好大的鐵鎚往 $1 頭上用力一敲! *** 『 鏘 !』 ***")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("舉起好大好大的鐵鎚往 " <> msg <> " 頭上用力一敲! *** 『 鏘 !』 ***")
  , Cmd "handshake" ("和在場的每一個人握手。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("和在場的每一個人握手。")
  , Cmd "hehe" ("「嘿嘿嘿....」地奸笑了幾聲。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("「嘿嘿嘿....」地奸笑了幾聲。")
  , Cmd "hello" ("對著大家大聲喊道︰Ｈｅｌｌｏ！大家好～～：Ｄ")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對著大家大聲喊道︰Ｈｅｌｌｏ！大家好～～：Ｄ")
  , Cmd "helpp" ("大叫:救命啊! 救命啊!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("大叫:救命啊! 救命啊!")
  , Cmd "hi" ("對所有的人打聲招呼 ..hi...:)")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對所有的人打聲招呼 ..hi...:)")
  , Cmd "hmm" ("「嗯」的一聲﹐一副欲言又止的樣子。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("「嗯」的一聲﹐一副欲言又止的樣子。")
  , Cmd "hoho" ("『呵..呵..呵』傻笑了幾聲。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("『呵..呵..呵』傻笑了幾聲。")
  , Cmd "hug" ("熱情擁抱 $1~^^")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("熱情擁抱 " <> msg <> "~^^")
  , Cmd "huge" ("緊緊地抱住了 $1，讓 $1 感到無比的深情。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("緊緊地抱住了 " <> msg <> "，讓 " <> msg <> " 感到無比的深情。")
  , Cmd "hungry" ("的肚子咕嚕咕嚕地叫的好大聲。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("的肚子咕嚕咕嚕地叫的好大聲。")
  , Cmd "idiot" ("突然覺得自己從沒像現在這麼愚蠢過。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("突然覺得自己從沒像現在這麼愚蠢過。")
  , Cmd "idle" ("無聊地坐在地上, 開始發起呆來了.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("無聊地坐在地上, 開始發起呆來了.")
  , Cmd "inn" ("感到十分委曲.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("感到十分委曲.")
  , Cmd "jump" ("高興地像小孩子似在 $1 四週蹦蹦跳跳.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("高興地像小孩子似在 " <> msg <> " 四週蹦蹦跳跳.")
  , Cmd "killair" ("殺氣騰騰﹐激起四周的氣流﹐產生一股狂風。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("殺氣騰騰﹐激起四周的氣流﹐產生一股狂風。")
  , Cmd "kiss" ("偷偷地在 $1 的臉頰上親了一下。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("偷偷地在 " <> msg <> " 的臉頰上親了一下。")
  , Cmd "kissy" ("激情的親著 $1 身上的每一個部位，並且訴說著自己的相思之情。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("激情的親著 " <> msg <> " 身上的每一個部位，並且訴說著自己的相思之情。")
  , Cmd "ko" ("矗立在雪蒼之頂，一臉冷漠傲視群雄，以ＫＯ每個人為己任。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("矗立在雪蒼之頂，一臉冷漠傲視群雄，以ＫＯ每個人為己任。")
  , Cmd "kok" ("舉起拳頭用力揮了揮, 看來有人要倒楣了.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("舉起拳頭用力揮了揮, 看來有人要倒楣了.")
  , Cmd "lag" ("慢慢地揮動雙手... 哇... 怎麼這麼慢!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("慢慢地揮動雙手... 哇... 怎麼這麼慢!")
  , Cmd "laugh" ("笑得倒在地上打滾。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("笑得倒在地上打滾。")
  , Cmd "lazy" ("覺得整個人懶懶的, 提不起精神來.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("覺得整個人懶懶的, 提不起精神來.")
  , Cmd "lick" ("貪婪地舔了舔 $1的臉。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("貪婪地舔了舔 " <> msg <> " 的臉。")
  , Cmd "lidle" ("跳起來對每個人大喊：人家要發呆了！你們不可以趁機欺負我喔～～")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("跳起來對每個人大喊：人家要發呆了！你們不可以趁機欺負我喔～～")
  , Cmd "lkiss" ("深情地看著 $1，給了 $1 淺淺卻無限情意的吻。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("深情地看著 " <> msg <> "，給了 " <> msg <> " 淺淺卻無限情意的吻。")
  , Cmd "moan" ("輕聲的呻吟著。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("輕聲的呻吟著。")
  , Cmd "nod" ("點了點頭。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("點了點頭。")
  , Cmd "ok" ("你說沒問題 ,一切有我 !!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("你說沒問題 ,一切有我 !!")
  , Cmd "ooxx" ("拿出筆在天空中迅速地畫了一沱便便!!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("拿出筆在天空中迅速地畫了一沱便便!!")
  , Cmd "p" ("敲敲 $1 的頭... \"你在耍白痴ㄚ!!!\"")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("敲敲 " <> msg <> " 的頭... \"你在耍白痴ㄚ!!!\"")
  , Cmd "pa" ("正正反反地抽了 $1 幾十個耳光,把 $1 的臉打得像柿子一樣, $1 傻笑著說:\"謝您,我感覺好多了.\"")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("正正反反地抽了 " <> msg <> " 幾十個耳光,把 " <> msg <> " 的臉打得像柿子一樣, " <> msg <> " 傻笑著說:\"謝您,我感覺好多了.\"")
  , Cmd "papa" ("拍拍 $1 的背,兄弟,這好料的給你上")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("拍拍 " <> msg <> " 的背,兄弟,這好料的給你上")
  , Cmd "pat" ("輕輕地拍著 $1 的頭。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("輕輕地拍著 " <> msg <> " 的頭。")
  , Cmd "pen" ("( ._.)_ψ_")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("( ._.)_ψ_")
  , Cmd "pig" ("好豬喔 !!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("好豬喔 !!")
  , Cmd "pk" ("對著藍藍的天空鬼叫鬼叫: 我要ＰＫ～～～～ＰＫ～～～～ＰＫ～～～～")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對著藍藍的天空鬼叫鬼叫: 我要ＰＫ～～～～ＰＫ～～～～ＰＫ～～～～")
  , Cmd "point" ("伸手指著 $1。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("伸手指著 " <> msg <> "。")
  , Cmd "poke" ("很無聊地戳 $1 一下。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("很無聊地戳 " <> msg <> " 一下。")
  , Cmd "pout" ("嘟著嘴巴鬧脾氣。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("嘟著嘴巴鬧脾氣。")
  , Cmd "pp" ("霹靂啪啦的把 $1 的嘴巴打得像豬嘴巴一樣, 並說 YOU SHUT UP!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("霹靂啪啦的把 " <> msg <> " 的嘴巴打得像豬嘴巴一樣, 並說 YOU SHUT UP!")
  , Cmd "ppp" ("霹靂啪啦的把 $1 的嘴巴打得像豬嘴巴一樣, 然後貼上撒隆巴斯說 乖, 去牆角蹲著")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("霹靂啪啦的把 " <> msg <> " 的嘴巴打得像豬嘴巴一樣, 然後貼上撒隆巴斯說 乖, 去牆角蹲著")
  , Cmd "puke" ("突然覺得胃一陣抽筋, 哇啦哇啦地吐了滿地.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("突然覺得胃一陣抽筋, 哇啦哇啦地吐了滿地.")
  , Cmd "pure" ("的腦袋一片空白.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("的腦袋一片空白.")
  , Cmd "robot" ("朝天大喊 : 無敵鐵金鋼 ~~ 無敵鐵金鋼 ~~ 無 敵 鐵 金 鋼!!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("朝天大喊 : 無敵鐵金鋼 ~~ 無敵鐵金鋼 ~~ 無 敵 鐵 金 鋼!!")
  , Cmd "room" ("對 $1 說：願意跟我去開房間嗎？")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對 " <> msg <> " 說：願意跟我去開房間嗎？")
  , Cmd "rose" ("手中捧著九十九朵嬌艷鮮紅的的玫瑰，對 $1 喃喃說到︰這些嬌艷的玫瑰，就像我所摯愛的他，亦象徵著我對他的愛，至死不渝。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("手中捧著九十九朵嬌艷鮮紅的的玫瑰，對 " <> msg <> " 喃喃說到︰這些嬌艷的玫瑰，就像我所摯愛的他，亦象徵著我對他的愛，至死不渝。")
  , Cmd "scowl" ("皺起眉來!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("皺起眉來!")
  , Cmd "scream" ("大聲尖叫。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("大聲尖叫。")
  , Cmd "sex" ("雙眼微張，櫻唇微開，向著大街上的人們搔首弄姿，賣弄風情。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("雙眼微張，櫻唇微開，向著大街上的人們搔首弄姿，賣弄風情。")
  , Cmd "sex1" ("將深邃的眼光望向 $1，纖纖玉手撥弄著 $1 的秀髮，看著 $1，不由得回到了舊日的時光，那倆小無猜的日子裡。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("將深邃的眼光望向 " <> msg <> "，纖纖玉手撥弄著 " <> msg <> " 的秀髮，看著 " <> msg <> "，不由得回到了舊日的時光，那倆小無猜的日子裡。")
  , Cmd "shake" ("緩緩地搖了搖頭.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("緩緩地搖了搖頭.")
  , Cmd "shiver" ("因寒冷而發抖。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("因寒冷而發抖。")
  , Cmd "shrug" ("無奈地聳聳肩.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("無奈地聳聳肩.")
  , Cmd "sigh" ("嘆了口氣。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("嘆了口氣。")
  , Cmd "sing" ("拉起五音不全的喉嚨哼起歌來! 「 啦 ..～ ﹏﹏」")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("拉起五音不全的喉嚨哼起歌來! 「 啦 ..～ ﹏﹏」")
  , Cmd "slap" ("狠狠摑了 $1 幾個大耳光, 打得 $1 滿天全金條, 要抓沒半條。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("狠狠摑了 " <> msg <> " 幾個大耳光, 打得 " <> msg <> " 滿天全金條, 要抓沒半條。")
  , Cmd "sleep" ("揉揉眼、打個哈欠，立刻躺倒在地上了。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("揉揉眼、打個哈欠，立刻躺倒在地上了。")
  , Cmd "slobber" ("流了滿地的口水 :D~~")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("流了滿地的口水 :D~~")
  , Cmd "sm" ("拿著蠟燭和皮鞭打量著每個人")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("拿著蠟燭和皮鞭打量著每個人")
  , Cmd "smile" ("愉快地微笑著。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("愉快地微笑著。")
  , Cmd "smirk" ("呵呵地傻笑。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("呵呵地傻笑。")
  , Cmd "snicker" ("在旁邊偷偷地笑.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("在旁邊偷偷地笑.")
  , Cmd "snort" ("哼了一聲。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("哼了一聲。")
  , Cmd "snowball" ("玩弄著手上的雪球.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("玩弄著手上的雪球.")
  , Cmd "sob" ("不停地哭哭啼啼....")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("不停地哭哭啼啼....")
  , Cmd "sorry" ("覺得很虧歉 $1!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("覺得很虧歉 " <> msg <> "!")
  , Cmd "spank" ("往 $1 的肩膀大力一拍，喊道：「老師ㄌ一ㄝ！幹得好！」")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("往 " <> msg <> " 的肩膀大力一拍，喊道：「老師ㄌ一ㄝ！幹得好！」")
  , Cmd "ssmile" ("露出陽光般燦爛的天真笑容。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("露出陽光般燦爛的天真笑容。")
  , Cmd "stare" ("用很奇怪的眼神瞄 $1。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("用很奇怪的眼神瞄 " <> msg <> "。")
  , Cmd "sweat" ("擦擦額頭上的汗水.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("擦擦額頭上的汗水.")
  , Cmd "tender" ("露出溫柔親切的表情!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("露出溫柔親切的表情!")
  , Cmd "think" ("低頭沉思.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("低頭沉思.")
  , Cmd "thx" ("對在場的所有人鞠躬道謝!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對在場的所有人鞠躬道謝!")
  , Cmd "tiger" ("對 $1 大叫：「哇哩勒？！　我聽你在虎爛～～」")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對 " <> msg <> " 大叫：「哇哩勒？！　我聽你在虎爛～～」")
  , Cmd "tsk" ("發出嘖嘖的聲音。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("發出嘖嘖的聲音。")
  , Cmd "ugly" ("對 $1 愁默默的說:本人150cm 100kg~米虫一隻 沒經濟可言, 妳願給個機會嗎?")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("對 " <> msg <> " 愁默默的說:本人150cm 100kg~米虫一隻 沒經濟可言, 妳願給個機會嗎?")
  , Cmd "unlag" ("不斷地揮動雙手大叫：哇..我變快了...天呀...怎辦.. ..")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("不斷地揮動雙手大叫：哇..我變快了...天呀...怎辦.. ..")
  , Cmd "wa" ("張大嘴, 好像看到不可思議的怪事.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("張大嘴, 好像看到不可思議的怪事.")
  , Cmd "waggle" ("搖搖食指對著 $1 說：「小朋友，這樣不可以喔！」")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("搖搖食指對著 " <> msg <> " 說：「小朋友，這樣不可以喔！」")
  , Cmd "wahaha" ("從背後拿出小旗子死命的揮舞著 ,大喊萬歲!!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("從背後拿出小旗子死命的揮舞著 ,大喊萬歲!!")
  , Cmd "wake" ("揉揉眼睛，清醒了過來。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("揉揉眼睛，清醒了過來。")
  , Cmd "water" ("向著 $1 喊: 小姐水不水,多大多高, 有否佳人在旁, 給不給虧啊~~")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("向著 " <> msg <> " 喊: 小姐水不水,多大多高, 有否佳人在旁, 給不給虧啊~~")
  , Cmd "wave" ("揮揮手。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("揮揮手。")
  , Cmd "what" ("說：『ㄟ! 哩公瞎米哇奈隴聽某?？?﹖?』")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("說：『ㄟ! 哩公瞎米哇奈隴聽某?？?﹖?』")
  , Cmd "wink" ("眨眨眼!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("眨眨眼!")
  , Cmd "wolf" ("在這一瞬間, 你覺得自己簡直跟色狼一樣.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("在這一瞬間, 你覺得自己簡直跟色狼一樣.")
  , Cmd "x" ("把 $1 捉起來，拿出一根狼牙棒，對著 $1 的 (_x_) 就給他ㄨ進去...唉呀！忘了baby oil...算了 ^__^ 下次補雙份好了...")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("把 " <> msg <> " 捉起來，拿出一根狼牙棒，對著 " <> msg <> " 的 (_x_) 就給他ㄨ進去...唉呀！忘了baby oil...算了 ^__^ 下次補雙份好了...")
  , Cmd "ya" ("得意的作出勝利的手勢 V 說: 「YA」 !!!")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("得意的作出勝利的手勢 V 說: 「YA」 !!!")
  , Cmd "yawn" ("打了一個哈欠.")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("打了一個哈欠.")
  , Cmd "zap" ("從天上召來一道閃電把 $1 化為一堆灰燼。")
    (LineArg "message") $
    \msg -> execMMCommand "me" ("從天上召來一道閃電把 " <> msg <> " 化為一堆灰燼。")
